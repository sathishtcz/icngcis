...
export default function Register() {
  return (
    <>
      <section className="w-full flex bg-right bg-cover  items-center justify-center relative bg-[url('/assets/images/register.jpg')] mt-18">
        ...
        <div className="relative container mx-auto px-6 py-8 lg:py-14 text-center text-white">
          ...
          <p className="text-[17px]   text-gray-200  text-justify leading-relaxed mx-auto mb-10">
          ...
          <div className="mt-10 grid md:grid-cols-3 gap-6 max-w-3xl mx-auto">
            <div className="p-6 bg-white/10 rounded-xl border border-white/20">
              ...
              <div className="font-semibold">7 <sup>th</sup> May 2025</div>
            </div>
